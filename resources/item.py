...
class Item(Resource):
    ...
    def put(cls, name: str):
        ...
        if item:
            ...
            item.priority = item_json["priority"]
        else:
            item_json["name"] = name
            item = item_schema.load(item_json)
...
class ItemPriorityFind(Resource):
    @classmethod
    def get(cls, priority: int):
        return {"items": item_list_schema.dump(ItemModel.find_by_priority(priority))}
